...
Return ONLY a valid JSON object exactly adhering to this schema:
{
  ...
  "must_have": ["string", "string"] (ONLY extract specific single skills, tools, and tags like "React" or "Agile". DO NOT extract sentences or full requirements),
  "nice_to_have": ["string", "string"] (ONLY extract specific single skills, tools, and tags. DO NOT extract sentences),
